...
#: Dataset-Quellen (Task-Focused Mode) — eigene Katalog-Liste, weil diese
#: Quellen Datensätze (nicht Papers) liefern und im Datasets-Tab + Task-Focused
#: Mode durchsuchbar sind. ``needs_key`` = Login nötig für Download (Suche geht
#: auch ohne). Die IDs müssen zu ``dataset_clients.DATASET_SOURCES`` passen.
DATASET_SOURCE_IDS: frozenset[str] = frozenset(
    {
        "zenodo",
        "figshare",
        "dryad",
